...
export default function RootLayout({
  ...
  <div className="flex items-center space-x-16">
    <a className="group text-primary transition-all duration-300 ease-in-out" href="/">
    ...
    <a className="group text-primary transition-all duration-300 ease-in-out" href="/project-proposal">
